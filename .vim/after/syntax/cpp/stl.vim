...
syn match cClass "\<[a-zA-Z0-9]\+\>::"me=e-2
syn match cRClass "\<\([A-Z][a-z]\+\)\+\>"
syn match cFunctions "\<[a-zA-Z_][a-zA-Z_0-9]*\>[^()]*)("me=e-2
syn match cFunctions "\<[a-zA-Z_][a-zA-Z_0-9]*\>\s*("me=e-1


syn match cConstvar "\<k\([A-Z][a-z]\+\)\+\>"
syn match cGlobalVar "\<g_[a-z]\+[a-z_]*\>"
syn match cClassVar "\<[a-z]\+[a-z_]*_\>"
syn match cSpecialWord "\<[A-Z_]\+\>"
